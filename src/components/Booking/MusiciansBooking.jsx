    ...
    <div className='text-black '>
        ...
        <div className='text-black bg-[#f71dc70c]'>
            <div className='flex flex-col items-center mb-12'>
                ...
                <div className='flex flex-row w-[80%] justify-between'>
                    <div className='flex flex-row gap-8 items-center'>
                        <img src={influencer1} alt="" className='shadow-2xl rounded-full' width={200}/>
                        <div className='flex flex-col'>
            ...
            <div className='flex flex-col items-center mb-12'>
                ...
                <div className='flex flex-row w-[80%] justify-between'>
                    <div className='flex flex-row gap-8 items-center'>
                        <img src={influencer2} alt="" className='shadow-2xl rounded-full' width={200}/>
                        <div className='flex flex-col'>
            ...
            <div className='flex flex-col items-center mb-12'>
                ...
                <div className='flex flex-row w-[80%] justify-between mb-16'>
                    <div className='flex flex-row gap-8 items-center'>
                        <img src={influencer3} alt="" className='shadow-2xl rounded-full' width={200}/>
                        <div className='flex flex-col'>
...
export default MusiciansBooking